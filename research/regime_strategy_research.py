...
TRADE_OUTPUT_FILE = "oil_gold_regime_strategy_trades.csv"
SUMMARY_OUTPUT_FILE = "oil_gold_regime_strategy_summary.csv"
COMPARISON_OUTPUT_FILE = (
    "oil_gold_regime_strategy_comparison.csv"
)
ROUND_DIGITS = 9
...
class RegimeStrategyConfig:
    ...
    def from_config_data(
        ...
        periods = tuple(
            _parse_period(
                value,
                "regime_strategy_research.periods",
            )
        ...
        try:
            ...
            raise ValueError(
                "regime_strategy_research.signal_type "
                "が不正です。"
            ) from exc
