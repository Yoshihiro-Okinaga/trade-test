...
STRATEGY_OUTPUT_FILE = (
    "aud_nzd_jpy_theme_strategies.csv"
)
TRADE_OUTPUT_FILE = (
    "aud_nzd_jpy_theme_trades.csv"
)
SUMMARY_OUTPUT_FILE = (
    "aud_nzd_jpy_theme_summary.csv"
)
BREADTH_OUTPUT_FILE = (
    "aud_nzd_jpy_theme_breadth.csv"
)

ROUND_DIGITS = 9

# AUD_NZD情報源テーマとして事前に記録されていた4 Target。
FROZEN_PERIODS = (
    (2001, 2005),
    (2006, 2010),
    (2011, 2015),
...
FROZEN_IS_STATS = {
    "EUR_JPY": {
        "trade_count": 206,
        "average_pct": 0.524579292,
        "win_rate": 55.339805825,
        "t_value": 2.470454690,
        "positive_year_ratio": 73.333333333,
    },
    "CAD_JPY": {
        "trade_count": 159,
        "average_pct": 0.717579823,
        "win_rate": 59.748427673,
        "t_value": 2.686123503,
        "positive_year_ratio": 66.666666667,
    },
    "CHF_JPY": {
        "trade_count": 206,
        "average_pct": 0.383713607,
        "win_rate": 53.883495146,
        "t_value": 1.767500539,
        "positive_year_ratio": 66.666666667,
    },
    "GBP_JPY": {
        "trade_count": 206,
        "average_pct": 0.501199345,
        "win_rate": 57.766990291,
        "t_value": 2.220649756,
        "positive_year_ratio": 80.000000000,
    },
}
...
FROZEN_TARGET_COST_SWAP = {
    "EUR_JPY": (0.004, 0.00412),
    "CAD_JPY": (0.006, 0.00355),
    "CHF_JPY": (0.008, -0.00159),
    "GBP_JPY": (0.009, 0.00791),
}


@dataclass(frozen=True)
class AudNzdJpyThemeConfig:
...
def run(
    ...
    theme_config = (
        AudNzdJpyThemeConfig.from_config_data(
            config_data
        )
    )
